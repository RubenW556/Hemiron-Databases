...
INSERT INTO $PG_DB_SCHEMA.database (id, name, type, created_at, pgd_id) VALUES ('ee85aca8-f829-468e-bca9-7db0a63688c2'::uuid, 'First test database'::varchar(50), 'postgres'::$PG_DB_SCHEMA.type_enum, '2023-01-11 11:42:37.127000'::timestamp, 16477::integer);
